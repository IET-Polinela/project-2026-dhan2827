"""
Django settings for iet_24782034_2026 project.
...
SECRET_KEY = 'django-insecure-2+)%(9q51vzk&pe%b)6j54wlf+(0xji30zc-l62!@@7#ih767i'
...
SPECTACULAR_SETTINGS = {
    ...
    'SERVERS': [
        {
            'url': 'http://103.151.63.85:8003',
            'description': 'Server IET Polinela'
        }
    ],
    'PREPROCESSING_HOOKS': [
        'smartcity_app.schema.remove_register_endpoint',
    ],
}